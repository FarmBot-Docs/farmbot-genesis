...
If the belts are tight and the gantry is twisted, re-equalize and synchronize the gantry using instructions on the [gantry page](../../assembly/gantry.md#step-8-equalize-the-gantry).
