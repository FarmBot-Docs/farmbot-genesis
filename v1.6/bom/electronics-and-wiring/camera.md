...
|Function     |Connect the camera to a Raspberry Pi using a Genesis <span class="fb-xl-sticker">XL</span> camera cable and take a photo from the FarmBot web app.|Photo taking should work as expected (no black images, no failures)|N/A
