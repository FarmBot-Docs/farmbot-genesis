...
content="In order to slide the z-axis through the v-wheels you will need to adjust the **[eccentric spacers](../bom/fasteners-and-hardware/eccentric-spacer.md)** of the three v-wheels on the right side of the cross-slide. Refer to the [eccentric spacer adjustment reference guide](../extras/reference/eccentric-spacer-adjustment.md) for how to do this."
%}
