...
If the belts are tight and the gantry is twisted, re-equalize and synchronize the gantry using instructions on the [gantry page](../../FarmBot-Genesis-V1.5/gantry/attach-the-drivetrain.md#step-3-equalize-the-gantry).
